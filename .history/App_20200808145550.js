...
export default class App extends Component{
  ...
  sendLayout = (e) => {
    console.log("starting point===> " + e.y);
    console.log('ending point===>'+ Number(e.y) + Number(e.height))
  }
    ...
    return(
      <View style={{flex: 1, margin: 5}}>
        <FlatList
          ...
          renderItem = {({item}) => <ListItem isVisible={true} _id={item.id} playVideo={this.state.playVideo} height={this.state.screenHeight/3} sendLayout={this.sendLayout.bind(this)}/>}
          windowSize= {5}
